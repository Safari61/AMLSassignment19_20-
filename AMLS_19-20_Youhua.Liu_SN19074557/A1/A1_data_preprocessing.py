...
gender = split[2]  # get the gender features
img_array = []
sex = []

for img in os.listdir(DATADIR):
    i = int(img.split('.')[0])  # create an integer type of counter to indicate the index of the array of sex[]
    ...
    if gender[i] == '-1':
        sex.append(0)
    if gender[i] == '1':
        sex.append(1)  # change labels from -1 and +1 to 0 and 1, and save labels to an array

# ======================================================================================================================
# when running it  on your own computer, please CHANGE THE PATH TO YOUR OWN PATH!!!!
# ======================================================================================================================
pickle_out = open("E:\machine learning\project\AMLS_assignment_kit\project_organization_example\AMLS_19-20_SN12345678\Datasets\sex.pickle","wb")
pickle.dump(sex, pickle_out)
